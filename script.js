...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('april 21,2026 00:00:00').getTime(),
...
const _slideDua = function () {
  ...
  setTimeout(function () {
    slideSatu.classList.replace('animate_slideInDown', 'animate_backOutDown');
  ...
  setTimeout(function () {
    tap.classList.remove('d-none');
    document.body.addEventListener('click', function () {
      slideDua.classList.replace('animate_zoomInDown', 'animate_fadeOutLeft');
      slideDua.classList.remove('animate_delay-2s', 'animate_slow');
      tap.classList.add('d-none');
      setTimeout(function () {
        slideDua.remove();
        _slideTiga();
...
const _slideTiga = function () {
  ...
  setTimeout(function () {
    tap.classList.remove('d-none');
    document.body.addEventListener('click', function () {
      slideTiga.classList.remove('animate_delay-2s', 'animate_slow');
      slideTiga.classList.replace('animate_fadeInRight', 'animate_fadeOut');
      tap.remove();
      setTimeout(function () {
        slideTiga.remove();
        _slideEmpat();
...
const _slideEmpat = function () {
  ...
  btn[1].addEventListener('click', function () {
    slideEmpat.classList.replace('animate_fadeInDown', 'animate_bounceOut');
...
const _slideLima = function () {
  ...
  slideLima.addEventListener('animationend', () => {
    ...
    slideLima.classList.replace('animate_bounceIn', 'animate_fadeOut');
    trims.classList.add('animate_animated', 'animatefadeOut', 'animate_delay-3s');
    setTimeout(() => {
      trims.remove();
      setTimeout(() => {
        slideLima.remove();
